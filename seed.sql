...
CREATE TABLE IF NOT EXISTS food_types (food_type TEXT);
CREATE TABLE IF NOT EXISTS donations_foodTypes (donations_id INTEGER, food_types_id INTEGER);

INSERT INTO users VALUES ("test@gmail.com", "123456", "test", "test_co", "225 Bush Street", "San Francisco", "California", "94104", "555-555-5555", "recipient");
