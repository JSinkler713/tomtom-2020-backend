...
let createDonationsTableQuery='CREATE TABLE IF NOT EXISTS donations (users_id INTEGER, type TEXT, pickup_time TEXT DEFAULT NULL, dropoff_point TEXT DEFAULT NULL, feeds_quantity INTEGER, fits_car INTEGER, additional_info TEXT, processing TEXT)'

let createFoodTypesTableQuery='CREATE TABLE IF NOT EXISTS food_types (type Text)'
